...
$total_servicios_sql = "SELECT COUNT(*) AS total_servicios FROM CompletadosMOVO";
...
$calificacion_promedio_sql = "SELECT AVG(calificacion) AS promedio_calificacion FROM CompletadosMOVO";
